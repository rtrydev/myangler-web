  ...
  return (
    <div className="min-h-screen paper-tex">
      ...
      <main className="max-w-6xl mx-auto px-8 py-12 space-y-20">
        ...
        {/* ─── Entry detail ─── */}
        <section>
          <Eyebrow withRule>Entry detail</Eyebrow>
          <div className="mt-6 grid md:grid-cols-2 gap-6">
            ...
            <Card className="p-6 flex flex-col gap-4">
              <Eyebrow gold>Bottom sheet</Eyebrow>
              <p className="serif italic text-ink-3 text-sm">
                The same detail wrapped in a <code className="mono">Sheet</code>{" "}
                surface (theme-aware dim, soft upward shadow, gold-hairline top
                edge). The dim and shadow tokens live in{" "}
                <code className="mono">--modal-dim</code> /{" "}
                <code className="mono">--modal-shadow</code>. Reused by the app
                for both the entry detail and the settings panel.
              </p>
          ...
          <div className="relative mt-4 h-120 overflow-hidden rounded-lg border border-border bg-paper">
            <Sheet
              open={modalOpen}
            ...
            {!modalOpen && (
              <div className="absolute inset-0 flex items-center justify-center serif italic text-ink-3">
        ...
        <section>
          ...
          <div className="mt-6 grid md:grid-cols-3 gap-4">
            ...
            <Card className="p-6 flex flex-col items-center justify-center gap-3 min-h-30">
              <RuleGold />
